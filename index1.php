...
<body>
   ...
   <div id="header-featured" style="background: black;">
    ...
    <div class="container menu-link" style="position: absolute;top:80%;left:50%">
          <a href="#pic" id="scroll"><div class="chevron"></div>
...
<div  class="row">
			...
			<div class="column" >
					<div class="post">
                            ...
                            <div class="post-s">
                                <a href="javascript:void(0)" style="text-decoration:none" id="donateBtn"><h2  button onclick="return kholModal(a);" id="myBtn"> DONATE</h2></a>
